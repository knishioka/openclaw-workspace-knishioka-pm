...
- [2026-04-29] feat(kpi): add structured dashboard output -- Upgraded @modelcontextprotocol/sdk to 1.29.0. Added structuredContent to freee_kpi_dashboard (company_id, period, profitability/safety/efficiency/liquidity sections) while preserving JSON text content. This is the first structured-output tool in the repo. (source: PR #178)
